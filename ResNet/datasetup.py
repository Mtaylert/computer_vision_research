...
class ImageNormalization:
    ...
    def read_data(self):
        data = ImageFolder(self.test_image_folder, transform=tt.Compose([
            tt.Resize(64),
            tt.RandomCrop(64),
            tt.ToTensor(),
        ]))
...
if __name__ == '__main__':
    imnorm = ImageNormalization(train_image_folder='../data/intel/seg_train/', test_image_folder='../data/intel/seg_test/')
